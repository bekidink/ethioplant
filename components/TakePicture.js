...
const TakePicture = () => {
  ...
  upload = async (image) => {
    ...
    fetch("http:///192.168.1.6:5000/upload", {
      method: "POST",
      body: data,
    })
      ...
      .then((response) => {
        ...
        setIsLoading(false);
        prediction(response.class, image.uri, response.confidence);
      });
  };
  ...
  return (
    <View style={styles.rect5Stack}>
      ...
      <TouchableOpacity style={styles.rect5} onPress={() => setIsVisible(true)}>
        <Text style={styles.takeAPicture}>ምስል ይውሰዱ</Text>
      </TouchableOpacity>
